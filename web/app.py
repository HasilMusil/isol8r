...
def dev_app() -> "Response":
    ...
    vm_flag_value = "flag{err0r:4rgum3nt_'vm'_must_n0t_be_'0'}"
    ...
    vm_flag_path = (FAKE_FLAGS_DIR / "vm_flag.txt").resolve()
    try:
        vm_flag_path.parent.mkdir(parents=True, exist_ok=True)
        vm_flag_path.write_text(vm_flag_value, encoding="utf-8")
    ...
    return "You might wanna check where the fake-flags are stored."
